...
from agent4_gradio_rag.backend.deps import get_current_user, db
from shared_core.models import UserProfile
from agent4_gradio_rag.backend.routers import dashboard, chat, offers, user, emails, notifications, profiles, accounts, transactions, settings
